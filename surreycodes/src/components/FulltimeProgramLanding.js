...
import IconCup from '../assets/IconBlueCup.svg';
import IconHeart from '../assets/IconGreenHeart.svg';
import IconPartners from '../assets/IconGreenPartner.svg';
    ...
    return(
        <div id="FulltimeProgram">
          ...
          <section className="landingSection">
            <img src="" alt="Our Campers Studying and Nonprofit can submit their projects" className="fulltime-program-hero"/>
            <div>
